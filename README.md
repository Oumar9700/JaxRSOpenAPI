...
1.Cloner le projet : git clone https://github.com/Oumar9700/concert_app/ puis l'ouvrir sous un éditeur, VsCode de preference
...
5. La branche par défaut est master et contient la version finale. si il y a probleme, la branche oumar est la plus a jour
